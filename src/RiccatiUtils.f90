...
contains
   ...
   subroutine apply_outerproduct_w(basis_out, basis_in, B, W)
      ...
      call assert_shape(W, (/ p, p /), 'apply_outer_product_w', 'W')
      ...
      return   
   end subroutine apply_outer_product_w
   ...
   subroutine apply_p_outerproduct_w(mat_out, UL, UR, B, W)
      ...
      call assert_shape(mat_out, (/ size(UL), size(UR) /), 'apply_p_outer_product_w', 'mat_out')
